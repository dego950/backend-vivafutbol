                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <a href="{{route('admin.permissions.create')}}" class="btn btn-outline-primary btn-sm mb-0" type="button">+&nbsp; Nuevo Permiso</a>
                        </div>
                    </div>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                @foreach($permissions as $permission)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold mb-0">{{$permission->created_at}}</p>
                                        </td>
                                        <td class="text-center">
                                            <table style="border: hidden" align="center">
                                                ...
                                                <td style="border: hidden">
                                                    <a href="{{route('admin.permissions.edit', $permission->id)}}" class="mx-0" data-bs-toggle="tooltip"
